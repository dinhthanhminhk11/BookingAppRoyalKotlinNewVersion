...
class ShimmerBestForYouAdapter(private val itemCount: Int) :
    RecyclerView.Adapter<ShimmerBestForYouAdapter.ShimmerViewHolder>() {
        inner class ShimmerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShimmerViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val itemView = inflater.inflate(R.layout.layout_shimmer_best_for_you_item, parent, false)
